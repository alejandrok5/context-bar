...
function detectWindowSize(modelId, signals = {}, config = null) {
  // Highest priority: a value pinned in the user config file. Already
  // validated by src/config.js (positive finite integer), so trust it.
